...
@WebServlet(name = "sortASCServlet", value = "/sortASCLastNameServlet")
public class sortASCLastNameServlet extends HttpServlet {
    ...
    private void sortNameASC(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Profile> listProfile = profileDao.listASCNameProfiles();
