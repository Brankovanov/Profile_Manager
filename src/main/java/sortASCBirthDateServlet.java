...
@WebServlet(name = "sortASCBirthDateServlet", value = "/sortASCBirthDateServlet")
public class sortASCBirthDateServlet extends HttpServlet {
    ...
    private void sortNameASC(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Profile> listProfile = profileDao.listASCBirthdate();
